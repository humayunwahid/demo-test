            ...
            <Col lg="9" sm="12" className='align-items-start'>
              <div className="player mobileMT-30">                  
                  <div className="single-video-live">
                      ...
                      {videoSrc ? (
                          <Fragment>
                            <RadiantNew link={videoSrc} adsManager={adsManager} title={title} version={'v2'} />
                          </Fragment>
                        ) : null}
...
SingleVideoMoviev2.displayName = "SingleVideoMoviev2";
export default SingleVideoMoviev2;