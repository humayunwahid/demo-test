        ...
        <Container fluid>
          <Row>
            <Col lg="3" md="5">
              ...
              <p><Link to={cast.site_link} target="_blank" className="text-uppercase">{cast.sites}</Link></p>
            ...
            <Col lg="9" md="7">
              ...
              <div className="seperator d-flex align-items-center flex-wrap mb-3">
                {cast.roles.map((item, index)=>{
                  return(
                    <>
                    <span className="fw-semibold text-capitalize" key={index}>{item}</span>
                    {index < cast.roles.length-1 ? <span className="circle"></span>: ''}
                    </>
                  )
                })}
              </div>
