...
const SingleVideo = memo(() => {
  useEnterExit();

  const playerRef = React.useRef(null);
  const { videoid, testvalue } = useParams();
  // alert(testvalue);
  // alert(videoid);
  ...
  return (
    <Fragment>
      <div className="iq-main-slider site-video padding-top-60">
        <Container fluid>
          <Row>
            <Col lg="12">
              <div className="pt-0">
                ...
                <iframe className="dailysingle" frameBorder="0" allowFullScreen={true} allow="autoplay" autoPlay={true}
                    ...
                    width="100%" 
                    src= { "https://geo.dailymotion.com/player/xahs0.html?video=" + videoid}>
                </iframe>
              </div>
            </Col>
          </Row>
