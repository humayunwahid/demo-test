                    ...
                    <Row >
                        <Col lg="4" md="5">
                            <div className="playlist-main-banner position-relative">
                                <Link to="/videos-detail" className="position-absolute top-0 bottom-0 start-0 end-0 z-1"></Link>
                                ...
                                <div className="img-detail z-3">
                                    <Link to="#" className="video-open playbtn text-decoration-none"
                                        ...
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns: xlink="http://www.w3.org/1999/xlink" x="0px"
                                            ...
                                            xml: space="preserve">
                                            <polygon className="triangle" fill="none" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-miterlimit="10" points="73.5,62.5 148.5,105.8 73.5,149.1 "></polygon>
                                            <circle className="circle" fill="none" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"
