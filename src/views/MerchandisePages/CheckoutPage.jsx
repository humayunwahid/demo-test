...
// img
import img4 from '/assets/images/shop/product/zap.png'
...
const CheckoutPage = memo(() => {
    ...
    const { subscriptionID, subscriptionName, stripePriceID, subscriptionPrice } = useParams();

    
    const [isLoading, setIsLoading] = useState(false);
    
    const [pLink, setpLink] = useState("stripe");

    const changePayment = (link) => {
        setpLink(link);
      };
  ...
  return (
    ...
    <Fragment>
        <BreadCrumbWidget title="Checkout" />
            ...
            {/* <div className="mb-5">
                <div className="d-flex align-items-center justify-content-center gap-3 flex-wrap">
                    <div className="woocommerce-info">
                        ...
                        <Link to="#" data-bs-toggle="collapse" data-bs-target="#apply-coupon" className="text-white">Click here
                ...
                <Form className="checkout-coupon">
                    ...
                    <div className="iq-checkout-coupon">
                        <input name="coupon-code" type="text" required="required" placeholder="Coupon code" className="form-control" />
            ...
            <Row>
                {/* <Col lg="8" md="7">
                    <Form action="">
                        ...
                        <div className="mb-4">
                            <input name="first-name" type="text" required="required" placeholder="First Name" className="form-control" />
                        </div>
                        <div className="mb-4">
                            <input name="last-name" type="text" required="required" placeholder="Last Name" className="form-control" />
                        </div>
                        <div className="mb-4">
                             <input name="billing-company" type="text" required="required" placeholder="Company" className="form-control" />
                        </div>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            <input name="billing-address" type="text" required="required" placeholder="House number and street name" className="form-control" />
                        </div>
                        <div className="mb-4">
                            <input name="billing-address2" type="text" required="required" placeholder="Apartment, suite, unit, etc. (optional)" className="form-control" />
                        </div>
                        <div className="mb-4">
                            <input name="city" type="text" required="required" placeholder="Town / City" className="form-control" />
                        </div>
                        <div className="mb-4">
                            <select className="select2-basic-single js-states form-control" aria-label="Default select example">
                        ...
                        <div className="mb-4">
                            <input name="postcode" type="text" required="required" placeholder="ZIP Code" className="form-control" />
                        </div>
                        <div className="mb-4">
                            <input name="phone" type="tel" required="required" placeholder="Phone Number" className="form-control" />
                        </div>
                        <div className="mb-4">
                            <input name="billing-company" type="email" required="required" placeholder="E-mail Address" className="form-control rounded-0 mb-5" />
                        </div>
                ...
                <Col lg="12" md="12">
                    <div className="order_review-box border p-4">
                        <h5 className="mb-3 mt-0 mt-md-2">Selected Subscription</h5>
                        <div className="checkout-review-order">
                                <Table className="table w-100" responsive>
                                    <tbody>
                                        <tr className="cart_item">                                    
                                            <td className="product-name">
                                                <div className="product-image"><img width="300" height="400" src={img4} className="cartimg" alt="image" loading="lazy" /></div>
                                                <div className="text">
                                                    <span className="fw-500 text-body">{subscriptionName} </span>
                                                    {/* <br /><strong className="text-white font-size-12 fw-bold">QTY:&nbsp;1</strong> */}
                                                </div>
                                            </td>
                                            <td className="product-total">
                                                <span className="Price-amount"><bdi className="fw-500 text-body"><span>Rs</span>{subscriptionPrice}</bdi></span>
                                            </td>
                                        </tr>
                                    ...
                                    <tfoot>
                                        <tr className="border-bottom">
                                            ...
                                            <td className="pe-0 p-3 fw-500 text-end">
                                                <span className="mb-0 text-body">Rs {subscriptionPrice}</span>
                                            </td>
                                        </tr>
                                        <tr className="border-bottom">
                                            <td className="ps-0 p-3 fw-500 font-size-18">Total (Tax Inclusive)</td>
                                            <td className="pe-0 p-3 fw-500 text-end">
                                                <span className="text-primary mb-0">Rs {subscriptionPrice}</span>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </Table>
                                <div className="checkout-payment mt-4 pt-3 pb-2">
                                        ...
                                        <div className="accordion" id="accordionPayment">
                                                ...
                                                <h6 className="accordion-header" id="payment-1">
                                                    <div className="accordion-button-payment" data-bs-toggle="collapse" data-bs-target="#collapseOnepayment" aria-expanded="true" aria-controls="collapseOnepayment">
                                                        <span className="form-check">
                                                            <input className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1" defaultChecked="checked" />
                                            ...
                                            <div className="accordion-item-payment">
                                                <h6 className="accordion-header" id="payment-1">
                                                    <div className="accordion-button-payment" data-bs-toggle="collapse" data-bs-target="#collapseOnepayment" aria-expanded="true" aria-controls="collapseOnepayment">
                                                        <span className="form-check">
                                                            <input onClick={() => changePayment("stripe")} className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1"  defaultChecked="checked" />
                                                            <label className="form-check-label" htmlFor="flexRadioDefault1">
                                            ...
                                            <div className="accordion-item-payment">
                                                ...
                                                <div className="accordion-button-payment collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwopayment" aria-expanded="false" aria-controls="collapseTwopayment">
                                                    <span className="form-check">
                                                        <input onClick={() => changePayment(`https://payment.aryzap.com?customer_id=${user.uid}&package_id=${subscriptionID}`)}  className="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" />
                                                        <label className="form-check-label" htmlFor="flexRadioDefault2">
                                                            Credit / Debit Card (UBL)
                                                        </label>
                                                    </span>                                                    
                                                </div>
                                                </h6>
                                    ...
                                    throughout this website, and for other purposes described in our <Link to="/PrivacyPolicy">privacy policy</Link>
                                    .</p>
                                    {/* temp = `https://payment.aryzap.com?customer_id=${user.uid}&package_id=${item._id}` */}
                                    
                                    {pLink === 'stripe' ? (
                                            <form action="https://payment.aryzap.com/create-checkout-session" method="POST">
                                                <input type="text" hidden value={user.uid} name="customer_id"/>
                                                <input type="text" hidden value={subscriptionID} name="package_id" />
                                                <input type="text" hidden value={stripePriceID} name="stripe_price_id" />
                                                <div className="iq-button">
                                                    <button type="submit" onClick={handleLinkClick} className="btn text-uppercase position-relative">
                                            ...
                                            <CustomButton  buttonTitle="Subscribe Now" link={pLink} linkButton="false" />
                                        )}
