              ...
              <tr data-item="list">
                                <td>
                                    <div className="product-thumbnail d-flex align-items-center gap-3">
                                        <Link className="d-block mb-2" to="#">
                                            <img className="avatar-80" src={img1}
                                                alt="" />
                                        </Link>
                            ...
                            <tr data-item="list">
                                <td>
                                    <div className="product-thumbnail d-flex align-items-center gap-3">
                                        <Link className="d-block mb-2" to="#">
                                            <img className="avatar-80" src={img2}
                                                alt="" />
                                        </Link>
                            ...
                            <tr data-item="list">
                                <td>
                                    <div className="product-thumbnail d-flex align-items-center gap-3">
                                        <Link className="d-block mb-2" to="#">
                                            <img className="avatar-80" src={img3}
                                                alt="" />
                                        </Link>
          ...
          <Col lg="4">
                <div className="cart_totals p-4">
                    ...
                    <div className="css_prefix-woocommerce-cart-box table-responsive">
                        ...
                        <div className="button-primary">
                        <CustomButton buttonTitle="Proceed to checkout" link="/checkout" linkButton="false"/>
                        </div>
                    </div>
                </div>
            </Col>
