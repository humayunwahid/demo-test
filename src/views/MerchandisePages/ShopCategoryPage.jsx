            ...
            <Tab.Container defaultActiveKey="first">
              <div className="d-flex align-items-center justify-content-between mb-5 shop-filter flex-wrap">
                <p>
                  ...
                  {length > 1 ? `all ${length} products` : "single product"}
                </p>
                <div className="d-flex align-items-center">
                  ...
                  <div className="iq-custom-select d-inline-block shop-select mt-4">
                    <select
                      name="cars"
                      className="form-control season-select mt-2"
                    >
              ...
              <Tab.Content className="tab-content" defaultActiveKey="third">
                {/* <!-- List View --> */}
                <Tab.Pane
                  id="pills-list-view"
                  eventKey="first"
