                        ...
                        <Row>
                            <Col lg="4" sm="6">
                                <div className='footer-inner'>
                                    ...
                                    <span className='d-inline-block mt-4 mb-0 font-size-14'> Email Us: <Link to="maito:customer@streamit.com">customer@streamit.com</Link></span>
                                    <div className="mt-5">
                                        ...
                                        <ul className="p-0 mt-4 mb-0 list-unstyled widget_social_media">
                                            <li className="">
                                                <Link to="https://www.facebook.com/" target="_blank" className="position-relative">
                                                    <i className="fab fa-facebook"></i>
                                                </Link>
                                            </li>
                                            <li className="">
                                                <Link to="https://twitter.com/" target="_blank" className="position-relative">
                                                    <i className="fab fa-twitter"></i>
                                                </Link>
                                            </li>
                                            <li className="">
                                                <Link to="https://github.com/" target="_blank" className="position-relative">
                                                    <i className="fab fa-github"></i>
                                                </Link>
                                            </li>
                                            <li className="">
                                                <Link to="https://www.instagram.com/" target="_blank" className="position-relative">
                                    ...
                                    <Row >
                                        <Col lg="6">
                                            <ul className="list-unstyled footer-menu mb-0">
                                                <li className="mb-2">
                                                    <Link to="/contact-us" className="ms-3">Contact Us</Link>
                                                </li>
                                                <li>
                                        ...
                                        <div className="col-lg-6 mt-lg-0 mt-2">
                                            <ul className="list-unstyled footer-menu mb-0">
                                                <li>
                                                    <Link to="/terms-of-use" className="ms-3">Terms Of Use</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </Row>
                    ...
                    <Container fluid>
                        <Row className="align-items-center">
                            <Col md="6" className="text-md-start text-center">
                                <p className="m-0 font-size-14 text-capitalize">© <span className="currentYear">{currentYear}</span><Link to="/"> STREAMIT </Link> All rights reserved.</p>
                            </Col>
                            <Col md="6" className="text-md-end text-center">
                                <p className="m-0 font-size-14">Powered by <Link to="https://iqonic.design/" target="_blank">IQONIC DESIGN</Link></p>
                            </Col>
                        </Row>
                    </Container>
                </div>
