                  ...
                  <div className="navbar-right menu-right">
                    <ul className="d-flex align-items-center justify-content-end gap-3 list-inline mb-0">
                      ...
                      <Dropdown as="li" className="nav-item nav-icon me-0">
                        ...
                        <Dropdown.Menu as="ul" className="dropdown-menu-end border-0 p-0 m-0 show">
                          ...
                          <li>
                            <Link to="/playlist" className="iq-sub-card d-flex align-items-center gap-3">
                          ...
                          <li>
                            <Link to="/login" className="iq-sub-card iq-logout-2 mt-1 d-flex justify-content-center gap-2">
              ...
              <Container fluid className="navbar-inner">
                ...
                <div className="d-xl-none d-flex gap-3 gap-xl-0 align-items-center">
                  ...
                  <Container fluid className="p-lg-0">
                    ...
                    <Nav.Item as="li">
                    <Nav.Link aria-expanded={open} href="#homePages" onClick={() => setOpen(!open)} className={`${location.pathname === '/merchandise-store' || location.pathname === '/' || location.pathname === '/home' || location.pathname === '/movies' || location.pathname === '/tv-shows' || location.pathname === '/videos' ? 'active': ''}`}>
                    ...
                    <Collapse in={open} className="sub-nav list-unstyled">
                      <ul>
                        <Nav.Item as="li">
                          <Link to="/" className={`${location.pathname === '/' ? 'active': ''} nav-link`}> OTT Home </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/home" className={`${location.pathname === '/home' ? 'active': ''} nav-link`}> Home </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/movies" className={`${location.pathname === '/movies' ? 'active': ''} nav-link`}> Movie </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/tv-shows" className={`${location.pathname === '/tv-shows' ? 'active': ''} nav-link`}> TV Show </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/videos" className={`${location.pathname === '/videos' ? 'active': ''} nav-link`}> Video </Link>
                        </Nav.Item>
                        <Nav.Item as="li" >
                          <Link to="/merchandise-store" className={`${location.pathname === '/merchandise-store' ? 'active': ''} nav-link`}> Merchandise Store </Link>
                        </Nav.Item>
                      </ul>
                    </Collapse>
                    </Nav.Item>
                    <Nav.Item as="li">
                    <Nav.Link aria-expanded={open1} href="#homePages" onClick={() => setOpen1(!open1)}>
                    ...
                    <Collapse in={open1} className="sub-nav list-unstyled">
                      <ul>
                        <Nav.Item as="li">
                          <Link to="/restricted-content" className={`${location.pathname === '/restricted-content' ? 'active': ''} nav-link`}> Restricted Content </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/related-merchandise" className={`${location.pathname === '/related-merchandise' ? 'active': ''} nav-link`}> Related Merchandise </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/playlist" className={`${location.pathname === '/playlist' ? 'active': ''} nav-link`}> Playlist </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/geners" className={`${location.pathname === '/geners' ? 'active': ''} nav-link`}> Genres </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/cast" className={`${location.pathname === '/cast' ? 'active': ''} nav-link`}> Cast </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/tags" className={`${location.pathname === '/tags' ? 'active': ''} nav-link`}> Tags </Link>
                        </Nav.Item>
                      </ul>
                    </Collapse>
                    </Nav.Item>
                    <Nav.Item as="li">
                    <Nav.Link aria-expanded={open2} href="#homePages" onClick={() => setOpen2(!open2)} className={`${location.pathname === '/about-us' || location.pathname === '/contact-us' || location.pathname === '/fa1' || location.pathname === '/PrivacyPolicy' || location.path === '/pricing' || location.pathname === '/coming-soon' ? 'active': ''}`}>
                    ...
                    <Collapse in={open2} className="sub-nav list-unstyled">
                      <ul>
                        ...
                        <Nav.Item as="li">
                          <Link to="/pricing" className="nav-link"> Pricing Plan </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/coming-soon" className="nav-link"> Coming Soon </Link>
                        </Nav.Item>
                    <Nav.Item as="li">
                    <Nav.Link aria-expanded={open3} href="#homePages" onClick={() => setOpen3(!open3)}>
                    ...
                    <Collapse in={open3} className="sub-nav list-unstyled">
                      <ul>
                        <Nav.Item as="li">
                          <Link to="/error-page-one" className="nav-link"> Error Page 1 </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/error-page-two" className="nav-link"> Error Page 2 </Link>
                        </Nav.Item>
                      </ul>
                    </Collapse>
                    </Nav.Item>
                    ...
                    <Nav.Item as="li">
                    <Nav.Link aria-expanded={open4} href="#homePages" onClick={() => setOpen4(!open4)} className={`${location.pathname === '/blogs' || location.pathname === '/blogs/single' || location.pathname === '/blogs/double' || location.pathname === '/blogs/large-grid' || location.pathname === 'blogs/small-grid' || location.pathname === '/blogs-sidebar/left' || location.pathname === '/blogs-sidebar/right'  || location.pathname === '/blog-template/everything-you-need-to-know-about' || location.pathname === '/blogs-detail/the-most-anticipated-movies' || location.pathname === '/blog-single/audio' || location.pathname === '/blog-single/video' || location.pathname === '/blog-single/link' || location.pathname === '/blog-single/quote' || location.pathname === '/blog-single/gallery' ? 'active': ''}`}>
                    ...
                    <Collapse in={open4} className="sub-nav list-unstyled">
                      <ul>
                        <Nav.Item as="li">
                          <Link to="/blogs" className={`${location.pathname === '/blogs' ? 'active': ''} nav-link`}> Listing </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                        <Nav.Link aria-expanded={open5} href="#homePages" onClick={() => setOpen5(!open5)} className={`${location.pathname === '/blogs/single' || location.pathname === '/blogs/double' || location.pathname === '/blogs/large-grid' || location.pathname === '/blogs/small-grid' ? 'active': ''}`}>
                        ...
                        <Collapse in={open5} className="sub-nav list-unstyled">
                          <ul>
                            <Nav.Item as="li">
                              <Link to="/blogs/single" className={`${location.pathname === '/blogs/single' ? 'active': ''} nav-link`}> 1 Column </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blogs/double" className={`${location.pathname === '/blogs/double' ? 'active': ''} nav-link`}> 2 column</Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blogs/large-grid" className={`${location.pathname === '/blogs/large-grid' ? 'active': ''} nav-link`}> 3 column </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blogs/small-grid" className={`${location.pathname === '/blogs/small-grid' ? 'active': ''} nav-link`}> 4 column </Link>
                            </Nav.Item>
                          </ul>
                        </Collapse>
                        </Nav.Item>
                        <Nav.Item as="li">
                        <Nav.Link aria-expanded={open6} href="#homePages" onClick={() => setOpen6(!open6)} className={`${location.pathname === '/blogs-sidebar/left' || location.pathname === '/blog-sidebar/right' ? 'active': ''}`}>
                        ...
                        <Collapse in={open6} className="sub-nav list-unstyled">
                          <ul>
                            <Nav.Item as="li">
                              <Link to="/blogs-sidebar/left" className={`${location.pathname === '/blog-sidebar/left' ? 'active': ''} nav-link`}> Left Sidebar </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blogs-sidebar/right" className={`${location.pathname === '/blog-sidebar/right' ? 'active': ''} nav-link`}> Right Sidebar </Link>
                            </Nav.Item>
                          </ul>
                        </Collapse>
                        </Nav.Item>
                        <Nav.Item as="li">
                        <Nav.Link aria-expanded={open7} href="#homePages" onClick={() => setOpen7(!open7)} className={`${location.pathname === '/blog-template/everything-you-need-to-know-about' || location.pathname === '/blogs-detail/the-most-anticipated-movies' || location.pathname === '/blog-single/audio' || location.pathname === '/blog-single/video' || location.pathname === '/blog-single/link' || location.pathname === '/blog-single/quote' || location.pathname === '/blog-single/gallery' ? 'active': ''}`}>
                        ...
                        <Collapse in={open7} className="sub-nav list-unstyled">
                          <ul>
                            <Nav.Item as="li">
                              <Link to="/blog-template/everything-you-need-to-know-about" className={`${location.pathname === '/blog-template/everything-you-need-to-know-about' ? 'active': ''} nav-link`}> Blog Template </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blogs-detail/the-most-anticipated-movies" className={`${location.pathname === '/blogs-detail/the-most-anticipated-movies' ? 'active': ''} nav-link`}> Standard </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blog-single/audio" className={`${location.pathname === '/blog-single/audio' ? 'active': ''} nav-link`}> Audio </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blog-single/video" className={`${location.pathname === '/blog-single/video' ? 'active': ''} nav-link`}> Video </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blog-single/link" className={`${location.pathname === '/blog-single/link' ? 'active': ''} nav-link`}> Link </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blog-single/quote" className={`${location.pathname === '/blog-single/quote' ? 'active': ''} nav-link`}> Quote </Link>
                            </Nav.Item>
                            <Nav.Item as="li">
                              <Link to="/blog-single/gallery" className={`${location.pathname === '/blog-single/gallery' ? 'active': ''} nav-link`}> Gallery </Link>
                            </Nav.Item>
                          </ul>
                        </Collapse>
                        </Nav.Item>
                    ...
                    <Nav.Item as="li">
                    <Nav.Link aria-expanded={open8} href="#homePages" onClick={() => setOpen8(!open8)} className={`${location.pathname === '/shop' || location.pathname === '/account' || location.pathname === '/cart' || location.pathname === '/wishlist' || location.pathname === '/checkout' || location.pathname === '/track-order' ? 'active': ''}`}>
                    ...
                    <Collapse in={open8} className="sub-nav list-unstyled">
                      <ul>
                        <Nav.Item as="li">
                          <Link to="/shop" className={`${location.pathname === '/shop' ? 'active': ''} nav-link`}> Shop </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/account" className={`${location.pathname === '/account' ? 'active': ''} nav-link`}> My Account Page </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/cart" className={`${location.pathname === '/cart' ? 'active': ''} nav-link`}> Cart Page </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/wishlist" className={`${location.pathname === '/wishlist' ? 'active': ''} nav-link`}> Wishlist Page </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/checkout" className={`${location.pathname === '/checkout' ? 'active': ''} nav-link`}> Checkout Page </Link>
                        </Nav.Item>
                        <Nav.Item as="li">
                          <Link to="/track-order" className={`${location.pathname === '/track-order' ? 'active': ''} nav-link`}> Order Tracking </Link>
                        </Nav.Item>
                      </ul>
                    </Collapse>
                    </Nav.Item>
                    ...
                    <div className={`p-3 navbar-collapse ${show1 === true ? 'collapse show' : 'collapse'}`} id="navbarSupportedContent">
                      <div className="iq-meta-menu-container d-xl-block d-none">
                        <ul className="d-flex align-items-center m-0 list-inline iq-meta-menu">
                          ...
                          <li>
                            <Link to="https://iqonic.desky.support/">Customer Support</Link>
                          </li>
                          <li>
                      ...
                      <div className="d-xl-none">
                        <ul className="d-flex align-items-center justify-content-end gap-3 list-inline mb-0">
                          ...
                          <li className="dropdown" id="itemdropdown2">
                            <a className="text-white d-flex align-items-center" href="#" id="navbarDropdown2" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <div className="cart-item-block d-flex gap-3">
                          ...
                          <div className="cart-block-content position-relative flex-grow-1 pe-5">
                            ...
                            <div className="position-absolute top-0 end-0">
                              <a href="javascript:void();" className="text-white delete-btn text-capitalize">delete</a>
                            </div>
                          </div>
                        </div>
                      </li>
