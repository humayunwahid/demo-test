          ...
          <article>
                      <div className="iq-blog-box" >
                        <div className="iq-blog-image clearfix">
                          <Link to={`/blogs-detail/${props.slug}`}><img src={props.thumbnail} alt=""  className='img-fluid w-100'/></Link>
                        </div>
                        <div className="iq-blog-detail">
                          ...
                          <div className="iq-button">
                            <Link className="btn text-uppercase position-relative" to={`/blogs-detail/${props.slug}`}>Read More
                          ...
                          <ul className="iq-blog-meta-cat-tag iq-blogtag">
                            ...
                            {props.tags.map((tags, index) => {
                              return (
                                <li key={index}><Link to="/blogs-tag">{tags}</Link></li>
                              )
                            })}
                          </ul>
                        </div>
