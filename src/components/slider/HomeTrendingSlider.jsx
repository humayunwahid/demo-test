                                  ...
                                  <div className="tab-title-info position-relative iq-ltr-direction">
                                    ...
                                    >
                                      <Nav.Item as="li" className="nav-item">
                                        <Nav.Link to="" eventKey="trending-data1">
                                          Overview
                                        </Nav.Link>
                                      </Nav.Item>
                                      <Nav.Item as="li" className="nav-item">
                                        <Nav.Link to="" eventKey="trending-data2">
                                          Episodes
                                        </Nav.Link>
                                      </Nav.Item>
                                        ...
                                        <div className="trending-list mt-4">
                                          <div className="text-primary title">
                                            ...
                                            {item.cast.map((item, index) => {
                                              return (
                                                <Link className='text-capitalize ms-2' key={index} to={`/cast-detail/movies/${item}`}>{item},</Link>
                                              )
                                            })}
                                          </div>
                                          <div className="text-primary title">
                                            ...
                                            {item.geners.map((item, index) => {
                                              return (
                                                <Link className='text-capitalize ms-2' key={index} to={`/view-all/tv-show/genre/${item}`}>{item},</Link>
                                              )
                                            })}
                                          </div>
                                          <div className="text-primary title">
                                        ...
                                        <div className="show-movie">
                                          ...
                                          <div className="animated fadeInUp">
                                            <div className="row episodes list-inline p-0 mb-0 iq-rtl-direction ms-4">
                                              {item.latest_episodes.map((item1, index) => {
                                                return (
