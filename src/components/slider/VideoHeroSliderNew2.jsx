...
const VideoHeroSliderNew2 = memo((props) => {
          ...
          <div id="banner-detail-slider" className="banner-container">
            <div className="movie-banner tvshows-slider">
              ...
              >
                ...
                <SwiperSlide>
                  <div className="movie-banner-imagenew">
                    <img src='https://arynews.tv/wp-content/uploads/2024/07/Noor-Jahan-01.webp' class="" alt="movie-banner-image" />
                  ...
                  <div className="shows-contentnew h-100">
                    <Row className="align-items-center h-100">
                      <Col lg="7" md="12" className="customPadding">
                        <h1
...
VideoHeroSliderNew2.displayName = "VideoHeroSliderNew2";
export default VideoHeroSliderNew2;
